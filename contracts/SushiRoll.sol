...
// SushiRoll helps your migrate your existing Uniswap LP tokens to CocoSwap LP ones
contract SushiRoll {
    ...
    function migrate(
        ...
        require(deadline >= block.timestamp, "CocoSwap: EXPIRED");
